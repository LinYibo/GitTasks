...
import type { ApplyRequest, GitTasksApi, OpenTarget, SyncMode } from '../shared/ipc-contract.ts'
...
const api: GitTasksApi = {
  ...
  sync: (mode: SyncMode) => ipcRenderer.invoke(CHANNELS.sync, mode),
  ...
  onStatusChanged: (listener) => subscribe(CHANNELS.statusChanged, listener),
}
